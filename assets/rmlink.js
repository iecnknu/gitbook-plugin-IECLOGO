require([
    ...
    function changeLink() {
        ...
        link.before('<div class="gitbook-link" style="text-align: center;"><br><strong>' + link.text() + '</strong><br><br><div style="letter-spacing: 8px;">國立高雄師範大學</div><div style="letter-spacing: 4px;">資訊教育中心授權使用<br>著作權所有，請勿轉載</div></div>');
        link.remove();
